...
#pragma once
#ifndef __VOTCA_XTP_HUNGARIAN_FILTER_H
#define __VOTCA_XTP_HUNGARIAN_FILTER_H
...
class Hungarian_filter : public StateFilter_base {
 public:
  std::string Identify() const final { return "hungarian"; }
